    ...
    <div className="panel always" id="panel-cuenta" style={{ marginTop: '1.25rem' }}>
      ...
      <div className="cuenta-grid" style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) minmax(0,1fr)', gap: '1rem', marginTop: '1rem' }}>
        <div className="cuenta-caja" style={{ background: '#0d151c', border: '1px solid #1a2733', borderRadius: '8px', overflow: 'hidden' }}>
          <div className="cuenta-caja-titulo" style={{ background: 'var(--accent)', color: '#000', fontWeight: '800', textAlign: 'center', padding: '0.65rem', textTransform: 'uppercase', fontSize: '0.85rem', letterSpacing: '0.05em' }}>PAGO</div>
          <div className="cuenta-caja-cuerpo" style={{ padding: '1rem' }}>
            <div className="cuenta-options" style={{ display: 'flex', gap: '1rem', marginBottom: '1rem' }}>
        ...
        <div className="cuenta-caja" style={{ background: '#0d151c', border: '1px solid #1a2733', borderRadius: '8px', overflow: 'hidden' }}>
          <div className="cuenta-caja-titulo" style={{ background: 'var(--accent)', color: '#000', fontWeight: '800', textAlign: 'center', padding: '0.65rem', textTransform: 'uppercase', fontSize: '0.85rem', letterSpacing: '0.05em' }}>DEBE</div>
          <div className="cuenta-caja-cuerpo" style={{ padding: '1rem' }}>
